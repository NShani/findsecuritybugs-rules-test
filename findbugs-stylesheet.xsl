        ...
        <html>
            ...
            <body>
                ...
                <script>
                    ...
                    <!--document.getElementById('item-array').getElementsByClassName('item')[1].className-->
                    ...
                    <!--for(var i = 0; i &lt; ele.length; i++){-->
                        <!--newDoc.append(ele[i]);-->
                    <!--}-->
                    <!--document.getElementById('item-array').innerHTML=newDoc;-->
                    <!--var elem = $('#item-array').find('div').sort(sortMe);-->
                    <!--('#item-array').append(ele);-->
                    console.log(ele);
